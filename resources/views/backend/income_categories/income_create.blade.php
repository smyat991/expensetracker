    		...
    		<div class="row justify-content-center">
      			<div class="col-md-12">
			        <div class="tile">
			        	<div class="tile-body">
			          		<div>
			           			<h3>Income Category Create Form</h3>
			            
					            <form method="post" action="{{route('income_categories.store')}}" enctype="multipart/form-data" class="mt-3">
					              @csrf
					              <div class="form-group row">
					                <label for="nameInput" class="col-sm-2 col-form-label">Income Name:</label>
					                <div class="col-sm-8">
